...
import 'package:myapp/navigator/search.dart';
import 'package:myapp/ui/product_details.dart';
        ...
        child: Container(
          child: Column(
            children: [
              ...
              DotsIndicator(dotsCount: image.length == 0 ? 1 : image.length,
